...
namespace Headquarters4DCS.GeneratedMission
{
    ...
    /// </summary>
    public sealed class Mission : IDisposable
    {
        /// <summary>
        ...
        /// </summary>
        public Country[][] Countries { get; set; } = new Country[2][];
        ...
        /// </summary>
        public MissionObjectiveLocation[] Objectives { get; set; }
        ...
        /// Mission unit groups.
        /// </summary>
        public List<MissionUnitGroup> UnitGroups { get; set; } = new List<MissionUnitGroup>();

        /// <summary>
        /// Mission waypoints.
        /// </summary>
        public MissionWaypoint[] Waypoints { get; set; }
