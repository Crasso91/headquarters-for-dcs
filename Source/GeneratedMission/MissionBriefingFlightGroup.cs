...
namespace Headquarters4DCS.GeneratedMission
{
    ...
    /// </summary>
    public struct MissionBriefingFlightGroup
    {
        /// <summary>
        ...
        public MissionBriefingFlightGroup(string callsign, string unitType, DCSAircraftTask task, string airbaseName, int unitCount = 1, float frequency = 0.0f, string tacan = null)
        {
            Callsign = callsign;
            UnitType = unitType;
            UnitCount = unitCount;
