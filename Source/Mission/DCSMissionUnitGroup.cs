...
namespace Headquarters4DCS.Mission
{
    ...
    /// </summary>
    public sealed class DCSMissionUnitGroup : IDisposable
    {
        /// <summary>
        ...
        /// </summary>
        public Dictionary<DCSMissionUnitGroupCustomValueKey, string> CustomValues = new Dictionary<DCSMissionUnitGroupCustomValueKey, string>();
