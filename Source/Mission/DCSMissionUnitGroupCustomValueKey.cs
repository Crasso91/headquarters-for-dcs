...
namespace Headquarters4DCS.Mission
{
    ...
    /// </summary>
    public struct DCSMissionUnitGroupCustomValueKey
    {
        /// <summary>
        ...
        public DCSMissionUnitGroupCustomValueKey(string key, int unitIndex = -1)
        {
        ...
        public static implicit operator DCSMissionUnitGroupCustomValueKey(string key) { return new DCSMissionUnitGroupCustomValueKey(key); }
        ...
        {
            if (obj is DCSMissionUnitGroupCustomValueKey)
                return (((DCSMissionUnitGroupCustomValueKey)obj).Key == Key) && (((DCSMissionUnitGroupCustomValueKey)obj).UnitIndex == UnitIndex);
